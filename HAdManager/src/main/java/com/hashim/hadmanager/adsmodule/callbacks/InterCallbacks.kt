...
interface InterCallbacks {
    ...
    fun hOnAddLoaded(hAdType: AdsType)
    fun hOnAdFailedToShowFullContent(hAdType: AdsType, hError: Error)
    fun hOnAddShowed(hAdType: AdsType)
    fun hOnAddDismissed(hAdType: AdsType)
}